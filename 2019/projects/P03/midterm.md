...
![](https://github.com/canlanqianyang/bitdm.github.io/new/master/2019/projects/P03/images/1.jpg)
对travel_time做一个log的特征变换, 一般对数变换为ln(x+1), 避免x=0而出现负无穷大, 可以看出经过对数变换后, 数据的分布非常均匀, 类似正态分布, 比较适合模型来处理。
![](https://github.com/canlanqianyang/bitdm.github.io/new/master/2019/projects/P03/images/2.jpg)
